...
namespace Exportador_FUMIT
{
    ...
    public class ClienteConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Cliente>
    {
        ...
        public ClienteConfiguration(string schema)
        {
            ...
            Property(x => x.Direccion).HasColumnName(@"Direccion").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(250);
            ...
            // Foreign keys
            HasRequired(a => a.Sucursale).WithMany(b => b.Clientes).HasForeignKey(c => c.SucursalId).WillCascadeOnDelete(false); // FK_Clientes_Sucursales
        }
    }
